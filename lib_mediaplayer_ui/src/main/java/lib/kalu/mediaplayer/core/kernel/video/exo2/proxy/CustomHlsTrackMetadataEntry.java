...
public final class CustomHlsTrackMetadataEntry implements Metadata.Entry {
  ...
  /* package */ CustomHlsTrackMetadataEntry(Parcel in) {
  ...
  public static final Creator<CustomHlsTrackMetadataEntry> CREATOR =
      new Creator<CustomHlsTrackMetadataEntry>() {
        @Override
        public CustomHlsTrackMetadataEntry createFromParcel(Parcel in) {
          return new CustomHlsTrackMetadataEntry(in);
        }

        @Override
        public CustomHlsTrackMetadataEntry[] newArray(int size) {
          return new CustomHlsTrackMetadataEntry[size];
        }
      };
}
