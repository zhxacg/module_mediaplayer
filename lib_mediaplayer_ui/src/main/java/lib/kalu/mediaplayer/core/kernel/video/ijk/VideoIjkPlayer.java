...
public final class VideoIjkPlayer extends VideoBasePlayer {
    ...
    public void initOptions(Context context, StartArgs args) {
        ...
        try {
            ...
            if (LogUtil.DEBUG) {
                LogUtil.log("VideoIjkPlayer -> initOptions -> step3 decoderType = " + decoderType + ", useMediaCodec = " + useMediaCodec);
            }
            ...
            if (LogUtil.DEBUG) {
                LogUtil.log("VideoIjkPlayer -> initOptions -> step3 Exception " + e.getMessage());
            }
        }
        ...
        try {
            ...
            if (LogUtil.DEBUG) {
                LogUtil.log("VideoIjkPlayer -> initOptions -> step4 Exception -> " + e.getMessage());
            }
        }
...
//            mIjkPlayer.setOption(codec, "skip_frame", 100); // // 跳过帧
            ...
            if (LogUtil.DEBUG) {
                LogUtil.log("VideoIjkPlayer -> initOptionsIjk -> step5 Exception -> " + e.getMessage());
            }
        }
    }
    ...
    public void seekTo(long seek) {
        try {
            ...
            if (seek < position) {
                onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.MEDIA_INFO_UPDATE_SEEK_START_REWIND);
            } else {
                onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.MEDIA_INFO_UPDATE_SEEK_START_FORWARD);
            }
...
//                        break;
                    ...
                    if (seek <= 0) {
                        ...
                        // 起播快进
                        onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.MEDIA_INFO_PLAY_WHEN_READY_SEEK);
    ...
    private OnSeekCompleteListener onSeekCompleteListener = new OnSeekCompleteListener() {
        ...
        public void onSeekComplete(IMediaPlayer iMediaPlayer) {
            ...
            onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.MEDIA_INFO_UPDATE_SEEK_FINISH);
    ...
    private OnPreparedListener onPreparedListener = new OnPreparedListener() {
        ...
        public void onPrepared(IMediaPlayer iMediaPlayer) {
            ...
            onEvent(PlayerType.KernelType.IJK, PlayerType.EventType.MEDIA_INFO_PREPARE);
            start();
        }
    };
