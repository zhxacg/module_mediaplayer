 ...
 */
@UnstableApi
public final class CusTsExtractor implements Extractor {

    /**
     * Creates a factory for {@link CusTsExtractor} instances with the provided {@link
     * SubtitleParser.Factory}.
     */
    public static ExtractorsFactory newFactory(SubtitleParser.Factory subtitleParserFactory) {
        return () -> new Extractor[]{new CusTsExtractor(subtitleParserFactory)};
    }
    ...
    public static final ExtractorsFactory FACTORY =
            () ->
                    new Extractor[]{
                            new CusTsExtractor(FLAG_EMIT_RAW_SUBTITLE_DATA, SubtitleParser.Factory.UNSUPPORTED)
                    };
    ...
    /**
     * @deprecated Use {@link #CusTsExtractor(SubtitleParser.Factory)} instead.
     */
    @Deprecated
    public CusTsExtractor() {
        this(
                MODE_SINGLE_PMT,
     ...
     *                              extraction.
     */
    public CusTsExtractor(SubtitleParser.Factory subtitleParserFactory) {
        this(
                MODE_SINGLE_PMT,
                /* extractorFlags= */ 0,
     ...
     *                              extraction.
     */
    public CusTsExtractor(@Flags int extractorFlags, SubtitleParser.Factory subtitleParserFactory) {
        this(
                MODE_SINGLE_PMT,
                extractorFlags,
                subtitleParserFactory,
    ...
    /**
     * @deprecated Use {@link #CusTsExtractor(int, int, SubtitleParser.Factory, TimestampAdjuster,
     * TsPayloadReader.Factory, int)} instead.
     */
    @Deprecated
    public CusTsExtractor(@DefaultTsPayloadReaderFactory.Flags int defaultTsPayloadReaderFlags) {
        this(
                MODE_SINGLE_PMT,
                FLAG_EMIT_RAW_SUBTITLE_DATA,
                SubtitleParser.Factory.UNSUPPORTED,
