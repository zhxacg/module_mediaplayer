...
public class TextRenderer extends BaseRenderer implements Callback {
    ...
    // We need to call both onCues method for backward compatibility.
    ...
    private void assertLegacyDecodingEnabledIfRequired() {
        if (!legacyDecodingEnabled) {
            checkState(Objects.equals(streamFormat.sampleMimeType, MimeTypes.APPLICATION_CEA608)
